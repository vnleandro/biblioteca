...
class App 
{
    ...
    {
        define('APP_HOST' , $_SERVER['HTTP_HOST'] . "/biblioteca");
        define('PATH' , realpath('./'));
        define('TITLE' , "SISTEMA CONTROLE DE BIBLIOTECA");
    ...
    public function run()
    {
        ...
        if (method_exists($nomeClasse)) {
            ...
            throw new Exception("Erro interno no sistema. Tente novamente mais tarde.", 500);
        }
        throw new Exception("Página não encontrada.", 404);
    }
